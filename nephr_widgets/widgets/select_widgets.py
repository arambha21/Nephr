...
This module is used to write nephr form select widgets
"""
...
class NephrMultiSelectWidget(forms.Widget):
    """
    NephrMultiSelectWidget
    """
    ...
    template_name = "nephr_widgets/nephr_multiselect_widget.html"
