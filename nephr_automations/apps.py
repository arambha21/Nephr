...
from nephr_automations.signals import start_automation


class NephrAutomationConfig(AppConfig):
    default_auto_field = "django.db.models.BigAutoField"
    name = "nephr_automations"

    def ready(self) -> None:
        ready = super().ready()
        try:

            from base.templatetags.nephrfilters import app_installed
            from employee.models import Employee
            from nephr_automations.methods.methods import get_related_models
            from nephr_automations.models import MODEL_CHOICES
