...
from nephr.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    Automation signals
    """
    from base.models import NephrMailTemplate
    from nephr_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=NephrMailTemplate)
    @receiver(post_save, sender=NephrMailTemplate)
...
def send_automated_mail(
    ...
    from nephr_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from nephr_automations.methods.methods import (
        get_model_class,
