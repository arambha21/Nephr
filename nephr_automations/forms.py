...
from nephr_automations.methods.methods import generate_choices
from nephr_automations.models import MODEL_CHOICES, MailAutomation
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["also_sent_to"] = NephrMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], NephrMultiSelectField):
