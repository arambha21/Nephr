"""
nephr_automations/views/cbvs.py
"""
...
from nephr_automations import models
from nephr_automations.filters import AutomationFilter
from nephr_automations.forms import AutomationForm
from nephr_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("nephr_automation.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.NephrSectionView):
    """
    ...
    template_name = "nephr_automations/section_view.html"
...
class AutomationNavView(views.NephrNavView):
    """
    AutomationNavView
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("nephr_automation.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.NephrFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "nephr_automations/automation_form.html"
...
class AutomationListView(views.NephrListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.NephrDetailedView):
    """
