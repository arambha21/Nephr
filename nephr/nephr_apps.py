...
This module is used to register nephr addons
"""

from nephr import settings
from nephr.settings import INSTALLED_APPS

INSTALLED_APPS.append("accessibility")
INSTALLED_APPS.append("nephr_audit")
INSTALLED_APPS.append("nephr_widgets")
INSTALLED_APPS.append("nephr_crumbs")
INSTALLED_APPS.append("nephr_documents")
INSTALLED_APPS.append("haystack")
INSTALLED_APPS.append("nephr_views")
INSTALLED_APPS.append("nephr_automations")
