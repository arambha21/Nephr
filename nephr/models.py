...
This module defines the abstract base model `NephrModel` for the Nephr HRMS project.
The `NephrModel` provides common fields and functionalities for other models within
...
class NephrModel(models.Model):
    ...
    nephr_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for NephrModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(NephrModel, self).save(*args, **kwargs)
...
auditlog.register(NephrModel, serialize_data=True)
