...
from base.models import NephrMailTemplate, JobPosition
...
from nephr.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = NephrMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        NephrMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
