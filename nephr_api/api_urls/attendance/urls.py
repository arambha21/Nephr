"""
nephr_api/urls/attendance/urls.py
"""

from django.urls import path

from nephr_api.api_views.attendance.permission_views import AttendancePermissionCheck
from nephr_api.api_views.attendance.views import *
