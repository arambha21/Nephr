...
from nephr_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "nephr_audit"


class NephrAuditInfo(models.Model):
    """
    NephrAuditInfo model to store additional info
    """
...
class NephrAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(NephrAuditLog, self).__init__(*args, **kwargs)
    #     self.is_nephr_audit_log = True
...
def pre_create_nephr_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_nephr_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, NephrAuditLog):
