...
from nephr.nephr_settings import DYNAMIC_URL_PATTERNS, NEPHR_DATE_FORMATS
from nephr.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = NEPHR_DATE_FORMATS.get(date_format)
