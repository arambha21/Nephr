...
from nephr_widgets.forms import NephrForm, orginal_template_name
...
class AllowanceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = NephrMultiSelectField(
...
class GeneratePayslipForm(NephrForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave"):
            AvailableLeave = get_nephr_model_class(
