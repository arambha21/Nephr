...
from nephr_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from nephr_views.forms import SavedFilterForm
from nephr_views.generic.cbv.views import NephrFormView, NephrListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.NephrModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(NephrFormView):
    """
    SavedFilter
    """
...
class DynamiListView(NephrListView):
    """
...
class NephrDeleteConfirmationView(View):
    """
