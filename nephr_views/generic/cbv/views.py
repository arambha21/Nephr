...
from nephr.filters import FilterSet
from nephr.group_by import group_by_queryset
from nephr.nephr_middlewares import _thread_locals
from nephr_views import models
from nephr_views.cbv_methods import (
    get_short_uuid,
    hx_request_required,
    paginator_qry,
    sortby,
...
from nephr_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from nephr_views.templatetags.generic_template_filters import getattribute


@method_decorator(hx_request_required, name="dispatch")
class NephrListView(ListView):
    """
    NephrListView
    """
    ...
    template_name: str = "generic/nephr_list_table.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        update_initial_cache(request, CACHE, NephrListView)
        ...
        if request and self._saved_filters.get("field"):
            ...
            for group in context["groups"]:
                for instance in group["list"]:
                    instance.ordered_ids = ordered_ids
                    ordered_ids.append(instance.pk)
        CACHE.get(self.request.session.session_key + "cbv")[NephrListView] = context
        from nephr.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class NephrListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = NephrListViewResorce()
...
class NephrSectionView(TemplateView):
    """
    Nephr Template View
    """
    ...
    template_name = "generic/nephr_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class NephrDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/nephr_detailed_view.html"
    header: dict = {
        "title": "Nephr",
        "subtitle": "Nephr Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, NephrDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class NephrTabView(TemplateView):
    """
    NephrTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/nephr_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, NephrTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[NephrTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class NephrCardView(ListView):
    """
    NephrCardView
    """
    ...
    template_name = "generic/nephr_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, NephrCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[NephrCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
class NephrFormView(FormView):
    ...
    template_name = "generic/nephr_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        update_initial_cache(request, CACHE, NephrFormView)
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    from nephr.urls import urlpatterns
            ...
            CACHE.get(self.request.session.session_key + "cbv")[NephrFormView] = form
            self.form = form
        return self.form


@method_decorator(hx_request_required, name="dispatch")
class NephrNavView(TemplateView):
    """
    NephrNavView
    ...
    template_name = "generic/nephr_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, NephrNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[NephrNavView] = context
        return context


@method_decorator(hx_request_required, name="dispatch")
class NephrProfileView(DetailView):
    """
    GenericNephrProfileView
    """

    template_name = "generic/nephr_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, NephrProfileView)
